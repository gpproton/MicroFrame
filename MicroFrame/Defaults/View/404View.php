...
<div class="center-align">
    <object class="center-align" style="min-height: 350px; min-width: auto;" type='image/svg+xml' data='<?=$root?>images/404.svg'></object>
</div>

<div class="center-align">
    <h4 class="center-align" style="color: firebrick; font-weight: 100;"><?=$errorText?></h4>
</div>
